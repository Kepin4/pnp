          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Topup</p>
                    <h5 class="font-weight-bolder mb-0 pt-2">
                      <?= number_format($Topup, 0, '.', '.') ?>
                      <span class="text-sm font-weight-bolder">Point</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Prize</p>
                    <h5 class="font-weight-bolder mb-0 pt-2">
                      <?= number_format($Prize, 0, '.', '.') ?>
                      <span class="text-sm font-weight-bolder">Point</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Cashback</p>
                    <h5 class="font-weight-bolder mb-0 pt-2">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Withdraw</p>
                    <h5 class="font-weight-bolder mb-0 pt-2">
                      <?= number_format($Withdraw * -1, 0, '.', '.') ?>
                      <span class="text-sm font-weight-bolder">Point</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Placement</p>
                    <h5 class="font-weight-bolder mb-0 pt-2">
                      <?= number_format($Placement, 0, '.', '.') ?>
                      <span class="text-sm font-weight-bolder">Point</span>
                    </h5>
                  </div>
                </div>
